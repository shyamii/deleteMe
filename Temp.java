...
import org.apache.hc.client5.http.socket.SchemeIOSessionStrategy;
...
public class RestClientConfig {
    ...
    public RestClient restClient() throws Exception {
        ...
        // 3. Create Registry for HTTPS scheme
        Registry<SchemeIOSessionStrategy> socketFactoryRegistry =
                RegistryBuilder.<SchemeIOSessionStrategy>create()
                        .register("https", sslSocketFactory)
                        .build();

        // 4. Create Connection Manager with the registry
...
import org.apache.hc.core5.http.config.Registry;
import org.apache.hc.core5.http.config.RegistryBuilder;
import org.apache.hc.core5.http.io.SocketConnectionFactory;
import org.apache.hc.core5.ssl.SSLContextBuilder;
import org.apache.hc.core5.ssl.TrustAllStrategy;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
...
public class RestClientConfig {
    ...
    public RestClient restClient() throws Exception {
        ...
        // 3. Create Registry with HTTPS scheme configuration
        Registry<SocketConnectionFactory> socketFactoryRegistry =
                RegistryBuilder.<SocketConnectionFactory>create()
                        .register("https", sslSocketFactory)
                        .build();
